function bannerAnimation(){
    ...
    // TweenMax.to([cta], 0.65, { scale: 1, ease: Back.easeOut, transformOrigin: "80px 560px", delay: 2.25 });
...
// window.addEventListener("body", mouseOvers());
// window.addEventListener("body", mouseleaves());
