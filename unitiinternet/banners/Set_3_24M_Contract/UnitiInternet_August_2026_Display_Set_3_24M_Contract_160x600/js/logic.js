...
function bannerAnimation(){
    ...
    TweenMax.set([copy4 ],  { opacity: 1, scale:0, transformOrigin: "80px 160px" });
    ...
    TweenMax.set([cta ],  { opacity: 1, scale: 0, transformOrigin: "80px 458px" });
    ...
    TweenMax.to([copy6], 0.75, { opacity : 1, x: 0, ease: Quad.easeOut, stagger: 0.35, delay: 2});
