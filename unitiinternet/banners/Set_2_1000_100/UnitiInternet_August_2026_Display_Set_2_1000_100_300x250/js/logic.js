function bannerAnimation(){
    ...
    TweenMax.set([cta ],  { opacity: 1, scale: 0, transformOrigin: "58px 230px" });
    TweenMax.set([product],  {x: 200, opacity: 1 });
    TweenMax.set([offer ],  { opacity: 1, scale: 0, transformOrigin: "225px 145px" });
    TweenMax.set([copy1, price1, price2],  {x: -200, opacity: 1 });
