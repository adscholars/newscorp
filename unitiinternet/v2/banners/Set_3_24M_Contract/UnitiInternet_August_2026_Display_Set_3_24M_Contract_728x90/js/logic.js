...
function bannerAnimation(){
    ...
    TweenMax.set([copy1, copy2, copy4,],  { opacity: 0, y: 20, });
    TweenMax.set([copy3 ],  { opacity: 1, scale:0, transformOrigin: "220px 60px" });
    TweenMax.set([cta ],  { opacity: 1, scale: 0, transformOrigin: "415px 60px" });
    TweenMax.set([copy5 ],  { opacity: 0, x: 50, });
    TweenMax.set([product ],  { opacity: 1, x: 300, });
    ...
    TweenMax.to([ copy3], 0.5, { scale: 1, ease: Back.easeOut, delay: 0.75 });
    TweenMax.to([ product ], 0.75, { x: 0, opacity: 1, ease: Back.easeOut, delay: 1 });
    TweenMax.to([ cta], 0.65, { scale:1, ease: Back.easeOut, delay: 1.25 });
    TweenMax.to([ copy5], 0.5, { x : 0, opacity: 1, ease: Quad.easeOut, delay: 1.75 });
