...
function bannerAnimation(){
    ...
    TweenMax.set([copy4 ],  { opacity: 1, scale:0, transformOrigin: "80px 115px" });
    TweenMax.set([copy6 ],  { opacity: 0, x: -50, });
    TweenMax.set([product ],  { opacity: 1, x: 150, });

    TweenMax.set([ product, optlogo, logo],  {opacity: 1, });
    TweenMax.set([cta ],  { opacity: 1, scale: 0, transformOrigin: "75px 185px" });
