function bannerAnimation(){
    ...
    TweenMax.set([cta ],  { opacity: 1, scale: 0, transformOrigin: "250px 45px" });
    TweenMax.set([product],  {x: 200, opacity: 1 });
    TweenMax.set([offer ],  { opacity: 1, scale: 0, transformOrigin: "510px 45px" });
    TweenMax.set([copy1, price1, price2],  {y: 90, opacity: 1 });
