function bannerAnimation(){
    ...
    TweenMax.to(copy1a, 0.65, { scale: 1, opacity: 1, transformOrigin: "125px 15px", ease: Back.easeOut, delay: 2.5});
    TweenMax.to(copy1b, 0.65, { scale: 1, opacity: 1, ease: Quad.easeOut, delay: 3 });
    TweenMax.to(copy1c, 0.65, { scale: 1, opacity: 1, transformOrigin: "143px 30px", ease: Back.easeOut, delay: 3.5 });
