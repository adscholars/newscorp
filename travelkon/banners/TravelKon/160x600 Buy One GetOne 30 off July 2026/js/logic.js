function bannerAnimation(){
    ...
    TweenMax.to(copy1a, 0.65, { scale: 1, opacity: 1, transformOrigin: "80px 105px", ease: Back.easeOut, delay: 2.5});
    TweenMax.to(copy1b, 0.65, { scale: 1, opacity: 1, ease: Quad.easeOut, delay: 3 });
    TweenMax.to(copy1c, 0.65, { scale: 1, opacity: 1, transformOrigin: "85px 200px", ease: Back.easeOut, delay: 3.5 });
    ...
    TweenMax.to(legal, 0.65, { opacity: 1, ease: Quad.easeOut, delay: 5.5 });
