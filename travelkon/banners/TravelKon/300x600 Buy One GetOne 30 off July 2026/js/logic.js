function bannerAnimation(){
    ...
    TweenMax.to(copy1a, 0.65, { scale: 1, opacity: 1, transformOrigin: "145px 70px", ease: Back.easeOut, delay: 2.5});
    TweenMax.to(copy1b, 0.65, { scale: 1, opacity: 1, ease: Quad.easeOut, delay: 3 });
    TweenMax.to(copy1c, 0.65, { scale: 1, opacity: 1, transformOrigin: "200px 115px", ease: Back.easeOut, delay: 3.5 });
