...
const COMMENTS_API = "https://script.google.com/macros/s/AKfycbwslrTkdGL_OAeUy9Gr1IjXsXQWLdbpbAftj4ELthlS4NzQFczqtbaXCxwSFP0KqPXf/exec";
...
function getBannerBackupImagePath(creative, item) {
    return `${BASE_PATH}${creative.creativeName}/${getRoutePart(creative)}${item.path}.png`;
}
...
function loadCreative(index) {
    ...
    currentCreative.sizes.forEach(item => {
        ...
        title.textContent = item.size + " | " + item.path;
